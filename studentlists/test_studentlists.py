...
from studentlists.studentlists import ClassList, StudentError
from unittest import TestCase


class TestStudentLists(TestCase):

    def test_if_max_students_is_zer_or_less(self):
        with self.assertRaises(StudentError):
            test_class = ClassList(-8)
    ...
    def test_add_students_remove_one_not_on_list(self):
    ...
    def test_students_not_in_class_is_not_enrolled(self):
        test_class = ClassList(4)
        test_class.add_student('Alice')
        test_class.add_student('Sven')
        # carl is not in class
    ...
    def test_index_of_student_empty_list(self):
        test_class = ClassList(5)
        self.assertIsNone(test_class.index_of_student('Sven'))
    ...
    def test_index_of_student_not_present_in_small_class(self):
        test_class = ClassList(3)
        self.assertIsNone(test_class.index_of_student('Sven'))

    ## TODO write a test for your new is_class_full method when the class is full.
    # use assertTrue.
    def test_if_class_is_full(self):
        test_class = ClassList(3)
        test_class.add_student('Harry')
        test_class.add_student('Hermione')
        test_class.add_student('Ron')
        test_class.add_student('Remy')
    ...
    def test_class_is_full_when_empty(self):
        test_class = ClassList(5)
        self.assertFalse(test_class.is_class_full())

    def test_class_is_full_when_not_full_or_empty(self):
        test_class = ClassList(5)
        test_class.add_student('Sven')
        test_class.add_student('Sean')
        self.assertFalse(test_class.is_class_full())
